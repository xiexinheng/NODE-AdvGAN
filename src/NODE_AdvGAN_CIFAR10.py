...
parser.add_argument('--target', default='CIFAR10', help='target_dataset')
parser.add_argument('--num_channel', default=3, help='')
...
target_model = load_target_model(args.target_model).to(device)
target_model.eval()
